...
export const formControlBaseClassName =
  "w-full rounded-md border border-border bg-surface text-start text-sm text-text placeholder:text-text-soft transition-colors duration-200 hover:border-border-strong focus:outline-none focus:border-border-strong focus:ring-4 focus:ring-border/60 disabled:pointer-events-none disabled:border-border disabled:bg-surface-muted disabled:text-text-soft disabled:opacity-70";
...
export const stepIndicatorClassNames = {
  ...
  completed: "border-primary/20 bg-primary-soft text-primary",
